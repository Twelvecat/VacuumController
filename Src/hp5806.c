...
void HP5806_A_Run(void)
{
	...
	HP5806_GetPressure(&hi2c1,&hp5806_A);
}
...
void HP5806_B_Run(void)
{
	...
	HP5806_GetTemperature(&hi2c2,&hp5806_B);
	user_hp5806_info("开始测量外置HP5806气压");
	HP5806_GetPressure(&hi2c2,&hp5806_B);
}
